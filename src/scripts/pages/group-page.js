...
async function setupGroup()
{
    ...
    const groupMemberNodes = groupMembers.map(groupMember => 
    {
        return groupMember.createGroupMember(groupMember);
    });
    groupMemberNodes.forEach(node => groupMemberElement.appendChild(node));
...
function createMyChatMessage(chatElement, userInputElement, message, className)
{
...
function createChatMessage(chatElement, userInputElement, chatMessage, className)
{
